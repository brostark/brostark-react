 ...
 */
export const conditionalCss = (valid = false, value, elseValue) => {
 ...
 * @returns
 */
export const formatDate = (date, removeHours = false) => {
 ...
 */
export const toFixedDigit = (number, digit = 2) => {
 ...
 */
export const displayOptionByKey = (options, key = "", defaultValue = "/") => {
    const keyString = key.toString();
    const option = options.find(o => o.key === keyString);
 ...
 */
export const compareEntries = (objectA, objectB, options = {}) => {
    const { strictFalse, } = options;
    const hasDifferentValue = !!Object.keys(objectA).find((key) => {
 ...
 */
export const enumToInputOptions = (entries) => {
