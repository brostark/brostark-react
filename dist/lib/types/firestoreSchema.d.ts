...
export declare enum FirestoreSchemaType {
    text = "text",
    date = "date",
    email = "email",
    password = "password",
...
export declare class FirestoreSchemaReferenceOption<T extends FirestoreDocument = FirestoreDocument> {
    props: {
...
export type FirestoreSchema = FirestoreSchemaDefault | FirestoreSchemaCustom | FirestoreSchemaFile | FirestoreSchemaObject | FirestoreSchemaSelect | FirestoreSchemaText | FirestoreSchemaNumber | FirestoreSchemaReference;
export {};
//# sourceMappingURL=firestoreSchema.d.ts.map